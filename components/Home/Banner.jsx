...
const Banner = () => {
    return (
        <section className="h-[90vh] w-full relative">
            <Image src={bottomshape} alt="bottomshape" className="absolute bottom-0 left-0 -z-10" />
            <Image src={shape2} alt="bottomshape" className="absolute bottom-24 left-1/3 -z-10" />
            ...
            <div className="container flex justify-center items-center h-full">
                <div className="flex flex-col-reverse md:flex-row justify-between items-center">
                    <div className="w-full md:w-1/2 relative text-center md:text-left">
                        ...
                        <h1 className="mb-6 mt-6 md:mt-0 md:mb-10 z-10 text-center md:text-left">Empowering
                            Entrepreneurs in
                            Their Life Changing
                            Endeavors.
                        </h1>
